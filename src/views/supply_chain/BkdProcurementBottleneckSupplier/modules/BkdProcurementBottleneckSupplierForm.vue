    ...
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="二级AAA名称" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="secondProductName">
              <a-input v-model="model.secondProductName" placeholder="请输入二级AAA名称"></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="二级AAA编号" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="secondProductId">
              <a-input v-model="model.secondProductId" placeholder="请输入二级AAA编号"></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="核心EEE编号" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="coreId">
              <a-input v-model="model.coreId" placeholder="请输入核心零件编号"></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
          ...
          <a-col :span="24">
            <a-form-model-item label="质检" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="quality">
              <a-input v-model="model.quality" placeholder="请输入质检"></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
...
export default {
  name: 'BkdProcurementBottleneckSupplierForm',
  components: {},
  props: {
    //表单禁用
    disabled: {
  ...
  data() {
    return {
      ...
      url: {
        add: '/BkdProcurementBottleneckSupplier/add',
        edit: '/BkdProcurementBottleneckSupplier/edit',
        queryById: '/BkdProcurementBottleneckSupplier/queryById'
      }
    }
  },
  computed: {
