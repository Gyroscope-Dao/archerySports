  ...
  export default {
    ...
    methods: {
      ...
      getSuperFieldList(){
        ...
        fieldList.push({type:'int',value:'privateEnterprise',text:'是否民口企业',dictCode:''})
        fieldList.push({type:'int',value:'battleneckSupplier',text:'是否瓶颈供应商',dictCode:''})
        ...
        fieldList.push({type:'int',value:'isProduct',text:'是否生产瓶颈供应商',dictCode:''})
        fieldList.push({type:'int',value:'isPurchase',text:'是否采购瓶颈供应商',dictCode:''})
