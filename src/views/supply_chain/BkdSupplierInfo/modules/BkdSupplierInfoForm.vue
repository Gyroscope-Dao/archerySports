    ...
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="AAA名称" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="supplierName">
              <a-input
                ...
                placeholder="请输入AAA名称"
              ></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="AAA类别" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="supplierCategory">
              <a-input v-model="model.supplierCategory" placeholder="请输入AAA类别"></a-input>
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item label="物料编号" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="productId">
              <a-input-number placeholder="请输入物料物料" v-model="model.productId" style="width: 100%" />
            </a-form-model-item>
          </a-col>
          <a-col :span="24">
            <a-form-model-item
          ...
          <a-col :span="24">
            <a-form-model-item label="地理位置" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="address">
              <a-input v-model="model.address" placeholder="请输入地理位置" ></a-input>
            </a-form-model-item>
          </a-col>
        </a-row>
      </a-form-model>
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        add: '/bkdSupplierInfo/add',
        edit: '/bkdSupplierInfo/edit',
        queryById: '/bkdSupplierInfo/queryById'
      }
    }
  },
  computed: {
