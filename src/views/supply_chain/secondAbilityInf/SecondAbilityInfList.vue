<template>
  <a-card :bordered="false">
   ...
   <div class="table-page-search-wrapper">
        ...
        <a-row :gutter="24">
          ...
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="物料编码">
              <a-input placeholder="请输入物料编码" v-model="queryParam.componentId"></a-input>
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
    ...
    <second-ability-inf-modal ref="modalForm" @ok="modalFormOk"></second-ability-inf-modal>
  </a-card>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      url: {
        list: '/secondAbilityInf/secondAbilityInf/list',
        delete: '/secondAbilityInf/secondAbilityInf/delete',
