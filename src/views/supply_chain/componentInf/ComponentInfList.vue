<template>
  <a-card :bordered="false">
   ...
   <div class="table-page-search-wrapper">
    ...
    <component-inf-modal ref="modalForm" @ok="modalFormOk"></component-inf-modal>
  </a-card>
</template>
...
<script>
  ...
  import ComponentInfModal from './modules/ComponentInfModal'

  export default {
    name: 'ComponentInfList',
    ...
    data () {
      return {
        ...
        url: {
          list: "/componentInf/componentInf/list",
          delete: "/componentInf/componentInf/delete",
          deleteBatch: "/componentInf/componentInf/deleteBatch",
          exportXlsUrl: "/componentInf/componentInf/exportXls",
          importExcelUrl: "componentInf/componentInf/importExcel",
