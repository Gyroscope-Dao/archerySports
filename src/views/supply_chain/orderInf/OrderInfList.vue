<template>
  <a-card :bordered="false">
    ...
    <order-inf-modal ref="modalForm" @ok="modalFormOk"></order-inf-modal>
  </a-card>
</template>
...
<script>
  ...
  import OrderInfModal from './modules/OrderInfModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/orderInf/orderInf/list",
          delete: "/orderInf/orderInf/delete",
