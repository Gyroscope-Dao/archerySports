...
export default {
  ...
  data() {
    return {
      ...
      validatorRules: {
        etpId: [{ required: true, message: '请输入单位编号!' }],
        eptName: [{ required: true, message: '请输入单位名称!' }],
        eptShortname: [{ required: true, message: '请输入单位简称!' }],
        mnemonicCode: [{ required: true, message: '请输入助记码!' }],
        dutyParagraph: [{ required: true, message: '请输入税号!' }],
        adminRegin: [{ required: true, message: '请输入行政区域!' }],
        address: [{ required: true, message: '请输入单位地址!' }],
        contactPerson: [{ required: true, message: '请输入联系人!' }],
        contactNumber: [{ required: true, message: '请输入联系电话!' }, { pattern: /^1[3|4|5|6|7|8|9][0-9]\d{8}$/, message: '请输入正确的手机号！'}],
        legalRepresent: [{ required: true, message: '请输入法定代表人!' }],
        postcode: [{ required: true, message: '请输入邮编!' }],
        bankName: [{ required: true, message: '请输入开户行名称!' }],
        bankAccount: [{ required: true, message: '请输入开户行账号!' }],
        permitId: [{ required: true, message: '请输入许可证编号!' }],
      },
      url: {
