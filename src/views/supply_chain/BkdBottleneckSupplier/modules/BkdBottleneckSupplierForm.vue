    ...
    <j-form-container :disabled="formDisabled">
      <a-form-model ref="form" :model="model" :rules="validatorRules" slot="detail">
        <a-row>
          ...
          <a-col :span="24">
            <a-form-model-item label="DDD" :labelCol="labelCol" :wrapperCol="wrapperCol" prop="procurement">
...
export default {
  name: 'BkdBottleneckSupplierForm',
  components: {},
  props: {
    //表单禁用
    disabled: {
  ...
  data() {
    return {
      ...
      url: {
        add: '/BkdBottleneckSupplier/add',
        edit: '/BkdBottleneckSupplier/edit',
        queryById: '/BkdBottleneckSupplier/queryById'
      }
    }
  },
  computed: {
